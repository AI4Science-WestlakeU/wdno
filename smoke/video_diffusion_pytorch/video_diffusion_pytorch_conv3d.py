...
# from video_diffusion_pytorch.gpu_mem_track import  MemTracker
# helpers functions
...
class SpatialLinearAttention(nn.Module):
    ...
    def forward(self, x):
       ...
       # print("          after to_qkv:", [x.shape for x in qkv])
...
class Unet3D_with_Conv3D(nn.Module):
    def __init__(
        self,
        dim,
        cond_dim = None,
    ...
    def forward(
        ...
        # print("after init conv:",x.element_size(),x.nelement())
